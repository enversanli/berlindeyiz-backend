    ...
    <div class="lg:flex md:w-full">
      <div
        ...
        <ul class="w-full px-4 text-2xl">
          <li class="w-1/2 float-left inline-block my-2"><i class="fas fa-map-marker-alt"></i> {{service.city.name}}</li>
          <li class="w-1/2 float-left inline-block my-2"><i class="fas fa-bookmark"></i> {{service.category.name}}</li>
          <li class="w-1/2 float-left inline-block my-2"><i class="fas fa-calendar-alt"></i> {{service.date_from}}</li>
          <li class="w-1/2 float-left inline-block my-2"><i class="fas fa-clock" v-if="service.start_time !== null"></i> {{service.start_time}}</li>
        </ul>
