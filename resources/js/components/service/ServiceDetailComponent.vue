      ...
      <div class="lg:flex md:w-full">
        ...
        <div
          ...
          <ul class="text-xl mb-4 block w-full">
            <li class="px-4 w-full" v-if="service.hasOwnProperty('meta.phone')">
              <a :href="'tel:'+ service.meta.phone"><i class="fas fa-phone"></i> {{ service.meta.phone }}</a>
            </li>

            <li class="px-4 w-full my-3" v-if="service.hasOwnProperty('meta.mail')">
              <a :href="'mailto:'+ service.meta.mail" target="_blank"><i class="fas fa-envelope"></i>
                {{ service.meta.mail }}</a>
            </li>

            <li class="px-4 w-full my-3" v-if="service.hasOwnProperty('meta.website')">
