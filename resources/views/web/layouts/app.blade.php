...
<head>
    ...
    <title>{{ config('app.name', 'Netsek') }}</title>
...
<div id="app">
    <div>
            ...
            <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Hızlı Linkler</h2>
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Haklarınız</h2>
                            <ul class="text-gray-600 dark:text-gray-400">
                                <li class="mb-4">
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="/" class="hover:underline">Berlideyiz™</a>. Tüm Hakları Saklıdır.
        </span>
