...
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div class="md:flex ">
        <div class="mb-6 md:mb-0 w-full lg:w-1/2 sm:w-full">
            ...
            <p class="pt-3">Berlin'in en çok etkinliği olan ve en çok konuşulan platformu olarak, sizleri
                biraraya getirmeye ve etkinliklerinizi <b>Berlin</b> genelinde tüm <b>Almanya</b>'ya
                duyurmaya devam ediyoruz.</p>
        </div>
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Hızlı
                    Linkler</h2>
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Bizi Takip Edin</h2>
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="https://www.facebook.com/profile.php?id=100087378266298" class="hover:underline ">Instagram</a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/berlindeyiz.de/?igshid=YmMyMTA2M2Y%3D" class="hover:underline">Facebook</a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a href="https://www.instagram.com/berlindeyiz.de/?igshid=YmMyMTA2M2Y%3D" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fill-rule="evenodd"
