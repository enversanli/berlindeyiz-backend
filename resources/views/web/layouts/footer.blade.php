<footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                        <a href="https://www.instagram.com/berlindeyiz.de/?igshid=YmMyMTA2M2Y%3D"
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/profile.php?id=100087378266298" target="_blank"
            ...
            <a href="https://www.instagram.com/berlindeyiz.de/?igshid=YmMyMTA2M2Y%3D" target="_blank"
               class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fill-rule="evenodd"
