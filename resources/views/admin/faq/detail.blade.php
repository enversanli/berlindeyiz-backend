        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <path id="XMLID_10_" d="M438,372H36.355l72.822-72.822c9.763-9.763,9.763-25.592,0-35.355c-9.763-9.764-25.593-9.762-35.355,0 l-115.5,115.5C-46.366,384.01-49,390.369-49,397s2.634,12.989,7.322,17.678l115.5,115.5c9.763,9.762,25.593,9.763,35.355,0 c9.763-9.763,9.763-25.592,0-35.355L36.355,422H438c13.808,0,25-11.193,25-25S451.808,372,438,372z"></path>
                    ...
                    <div class="py-12">
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                <h1>@lang('common.new_question')</h1>
                                <div class="p-6 bg-white border-b border-gray-200">
                                    ...
                                    <form action="{{route('faq.update', $question->id)}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="flex w-full mobile-companent">
                                            <div class="w-full mr-3 mobile-input">
                                                ...
                                                <x-input id="title" maxlength="35" minlength="1"
                                                         ...
                                                         :value="$question->title" name="title" required autofocus/>
                                            </div>
                                        ...
                                        <div class="flex w-full mobile-companent">
                                            <div class="w-full mr-3 mt-4 mobile-input">
                                                ...
                                                <textarea name="text" class="border border-gray-300 w-full" style="min-height: 300px">{{$question->text}}</textarea>
                                            </div>
                                        </div>
